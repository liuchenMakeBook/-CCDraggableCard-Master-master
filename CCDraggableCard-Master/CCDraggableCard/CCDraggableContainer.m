...
//                
//                UISwipeGestureRecognizer *swipeLeft = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(swipeGestureHandle:)];
//                swipeLeft.direction = UISwipeGestureRecognizerDirectionLeft;
//                [cardView addGestureRecognizer:swipeLeft];
//                
//                UISwipeGestureRecognizer *swipeDown = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(swipeGestureHandle:)];
//                swipeDown.direction = UISwipeGestureRecognizerDirectionDown;
//                [cardView addGestureRecognizer:swipeDown];
//
//                UISwipeGestureRecognizer *swipeUp = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(swipeGestureHandle:)];
...
- (void)swipeGestureHandle:(UISwipeGestureRecognizer *)gesture {
    if (gesture.direction == UISwipeGestureRecognizerDirectionRight || gesture.direction == UISwipeGestureRecognizerDirectionUp) {
        [self removeFormDirection:CCDraggableDirectionRight];
    }else if(gesture.direction == UISwipeGestureRecognizerDirectionLeft || gesture.direction == UISwipeGestureRecognizerDirectionDown){
        [self removeFormDirection:CCDraggableDirectionLeft];
    }
}
